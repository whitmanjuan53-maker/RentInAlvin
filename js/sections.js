...
function Availability({
  ...
  return /*#__PURE__*/React.createElement("section", {
    id: "availability",
    style: {
      padding: compact ? "56px var(--pad-x)" : "80px var(--pad-x)",
      background: p.paper
    }
  ...
  }), "Open this week"), /*#__PURE__*/React.createElement("h2", {
    style: {
  ...
  }, limit ? "Available right now." : "See what's open.")), !limit && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      flexWrap: "wrap"
  ...
  }, "No units match. Call us \u2014 we may have something coming up."), filtered.map((u, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      background: p.bg,
      padding: 24,
  ...
  }, u.featured && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      top: 16,
      right: 16,
  ...
  }, "Featured"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      letterSpacing: "0.08em",
      textTransform: "uppercase",
  ...
  }, u.property), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: `'${displayFont}', serif`,
      fontSize: 22,
      lineHeight: 1.1,
  ...
  }, u.type), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: p.inkSoft,
      marginTop: 4
    }
  }, u.addr, " \xB7 ", u.sqft, " sq ft")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between",
      alignItems: "baseline",
  ...
  }, "$", u.price.toLocaleString(), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
      color: p.inkSoft,
...
function getMapProps() {
  ...
  return [{
    ...
    lng: -95.2442,
    office: true,
    heroImage: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&h=300&fit=crop&q=80",
    description: "Our flagship community and company headquarters.",
    ...
    lng: -95.2441,
    office: false,
    heroImage: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=400&h=300&fit=crop&q=80",
    description: "Spacious two-story townhomes with private entries.",
    note: "Two-story townhomes with private entries and 2.5 baths.",
    price: "from $1,250"
  }, {
    id: 2,
    slug: "kings-haven-100",
    name: "King's Haven (100)",
    addr: "100 S 2nd St",
    fullAddr: "100 S 2nd St, Alvin, TX 77511",
    lat: 29.4235,
    lng: -95.2439,
    office: false,
    heroImage: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=400&h=300&fit=crop&q=80",
    description: "A quieter sister location with newly renovated interiors.",
    ...
    lng: -95.2330,
    office: false,
    heroImage: "https://images.unsplash.com/photo-1600573472592-401b489a3cdc?w=400&h=300&fit=crop&q=80",
    description: "Our largest community along the bypass.",
    ...
    lng: -95.2550,
    office: false,
    heroImage: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&h=300&fit=crop&q=80",
    description: "Classic white-clad architecture on a quiet street.",
...
function AlvinMap({
  ...
  const Fallback = () => /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
  ...
  }, props.map(m => /*#__PURE__*/React.createElement("a", {
    key: m.id,
    href: `https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(m.fullAddr)}`,
    target: "_blank",
    rel: "noopener",
    style: {
      display: "inline-flex",
  ...
  }, m.office ? "★" : m.id + 1), m.name, /*#__PURE__*/React.createElement("svg", {
    width: "12",
    height: "12",
    viewBox: "0 0 12 12",
    fill: "none"
  ...
  return /*#__PURE__*/React.createElement("section", {
    id: "map",
    style: {
      padding: isMobile ? "56px var(--pad-x)" : "80px var(--pad-x)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 1280,
  ...
  }, "Explore our communities"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: `'${displayFont}', serif`,
  ...
  }, "Find Apartments in Alvin"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 17,
      lineHeight: 1.6,
      color: p.inkSoft,
  ...
  }, "Click any property on the map to see details, or tap a location in the list to focus its pin.")), isMobile && /*#__PURE__*/React.createElement("div", {
    className: "ys-mobile-cards",
    style: {
      display: "flex",
      gap: 10,
      overflowX: "auto",
  ...
  }, /*#__PURE__*/React.createElement("style", null, `.ys-mobile-cards::-webkit-scrollbar { display: none; }`), props.map(m => {
    ...
    }, m.office ? "★" : m.id + 1), /*#__PURE__*/React.createElement("div", {
      style: {
        minWidth: 0
      }
    }, /*#__PURE__*/React.createElement("div", {
  ...
  }), /*#__PURE__*/React.createElement("style", null, `@keyframes ys-spin { to { transform: rotate(360deg); } }`)))))));
}
...
function FAQ({
  ...
  }, "Things renters usually ask first."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 15,
      lineHeight: 1.6,
      color: p.inkSoft,
  ...
  }, "Don't see your question? Call ", /*#__PURE__*/React.createElement("a", {
    href: "tel:8322103968",
    style: {
      color: p.primary,
      textDecoration: "none",
  ...
  }, "(832) 210-3968"), ".")), /*#__PURE__*/React.createElement("div", null, FAQS.map((f, i) => {
    const isOpen = open === i;
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
