...
function PropertyImage({ src, alt, p }) {
...
function Nav({ p }) {
  ...
  return (
    <header className="ys-nav" style={{
      ...
      <nav className="ys-nav-links" style={{ display: "flex", alignItems: "center", gap: 32 }}>
        ...
        <a href="#apply" style={{
          color: p.paper, textDecoration: "none", fontSize: 14, fontWeight: 600,
          padding: "9px 20px", background: p.primary, borderRadius: 8,
          transition: "all 200ms ease",
          boxShadow: "0 2px 8px rgba(27, 42, 74, 0.12)"
        }}
        onMouseOver={(e) => {e.currentTarget.style.background = p.primarySoft;e.currentTarget.style.transform = "translateY(-1px)";e.currentTarget.style.boxShadow = "0 4px 14px rgba(27, 42, 74, 0.18)";}}
        onMouseOut={(e) => {e.currentTarget.style.background = p.primary;e.currentTarget.style.transform = "translateY(0)";e.currentTarget.style.boxShadow = "0 2px 8px rgba(27, 42, 74, 0.12)";}}>
          Apply Now</a>
      </nav>
      <button className="ys-nav-burger" onClick={() => setMenuOpen((o) => !o)} aria-label="Menu" style={{
        display: "none",
        background: "transparent", border: `1px solid ${p.line}`, borderRadius: 8,
        width: 42, height: 42, padding: 0, cursor: "pointer",
      ...
      <div className="ys-nav-mobile" style={{
        ...
        <a key={href} href={href} onClick={() => setMenuOpen(false)} style={{
          ...
          padding: "14px 0", borderBottom: i < links.length - 1 ? `1px solid ${p.line}` : "none",
          transition: "color 200ms ease"
        }}
        onMouseOver={(e) => e.currentTarget.style.color = p.accent}
        onMouseOut={(e) => e.currentTarget.style.color = p.ink}>{label}</a>
        )}
        ...
        <div className="ys-hero-row" style={{
          ...
          <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
            ...
            <a href="#properties" style={{
              padding: "15px 28px", background: p.paper, color: p.ink,
              textDecoration: "none", fontSize: 15, fontWeight: 600,
              borderRadius: 10, border: `1px solid ${p.line}`,
              transition: "all 200ms ease",
              boxShadow: "0 2px 8px rgba(27, 42, 74, 0.06)"
            }}
            onMouseOver={(e) => {e.currentTarget.style.background = p.ink;e.currentTarget.style.color = p.paper;e.currentTarget.style.borderColor = p.ink;e.currentTarget.style.transform = "translateY(-2px)";e.currentTarget.style.boxShadow = "0 6px 18px rgba(27, 42, 74, 0.14)";}}
            onMouseOut={(e) => {e.currentTarget.style.background = p.paper;e.currentTarget.style.color = p.ink;e.currentTarget.style.borderColor = p.line;e.currentTarget.style.transform = "translateY(0)";e.currentTarget.style.boxShadow = "0 2px 8px rgba(27, 42, 74, 0.06)";}}>
              See properties
            </a>
          </div>
        </div>
...
function SectionHead({ p, eyebrow, title, lead, displayFont }) {
  return (
    <div className="ys-section-head" style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 48, alignItems: "start", marginBottom: 48 }}>
      <div style={{
        fontSize: 12, letterSpacing: "0.14em", textTransform: "uppercase",
  ...
  return (
    <article
      ...
      <div style={{ position: "relative", aspectRatio: "4/3", overflow: "hidden", background: p.bg }}>
        <PropertyImage src={prop.img} alt={prop.name} p={p} />
        <div style={{
    ...
    <section id="floorplans" style={{
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        <div className="ys-section-head" style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 48, alignItems: "start", marginBottom: 48 }}>
          ...
          <div>
            <h2 style={{
              ...
              fontSize: "clamp(32px, 4vw, 52px)",
              lineHeight: 1.05, letterSpacing: "-0.02em",
              margin: 0, fontWeight: 400, maxWidth: "18ch",
              color: p.paper
            }}>
            ...
            <p style={{
              ...
              Rents are listed up-front with no surprise fees. Call to confirm current availability.
            </p>
          </div>
        </div>
        ...
        <div className="ys-floor-grid" style={{
          ...
          <div style={{ borderTop: `1px solid color-mix(in oklab, ${p.paper} 18%, transparent)` }}>
            {FLOORPLANS.map((f, i) =>
            <button
              key={i}
              onClick={() => setActive(i)}
              ...
              style={{
                ...
                <span style={{
                fontFamily: `'${displayFont}', serif`,
                fontSize: "clamp(22px, 2.4vw, 28px)", fontWeight: 400, letterSpacing: "-0.01em"
              }}>
                  {f.type}
                </span>
                <span style={{
          ...
          <div className="ys-floor-detail" style={{
            ...
            <h3 style={{
              fontFamily: `'${displayFont}', serif`,
              fontSize: "clamp(36px, 4vw, 48px)", fontWeight: 400, letterSpacing: "-0.02em",
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", opacity: 0.55, marginBottom: 6, fontWeight: 500 }}>Square feet</div>
                <div style={{ fontSize: 17 }}>{FLOORPLANS[active].sqft}</div>
              </div>
              <div>
                <div style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", opacity: 0.55, marginBottom: 6, fontWeight: 500 }}>Monthly rent</div>
                <div style={{ fontSize: 17 }}>{FLOORPLANS[active].price}</div>
              </div>
              <div>
                <div style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", opacity: 0.55, marginBottom: 6, fontWeight: 500 }}>Available now</div>
                <div style={{ fontSize: 17 }}>{FLOORPLANS[active].available} units</div>
              </div>
              <div>
                <div style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", opacity: 0.55, marginBottom: 6, fontWeight: 500 }}>Deposit</div>
            ...
            onMouseOver={(e) => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 6px 24px rgba(184, 134, 11, 0.35)"; }}
            onMouseOut={(e) => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 4px 16px rgba(184, 134, 11, 0.25)"; }}>
              Schedule a viewing
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M3 7h8m0 0L7.5 3.5M11 7l-3.5 3.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /></svg>
            </a>
          </div>
  ...
  return (
    <section id="about" style={{ padding: "var(--pad-x-lg) var(--pad-x)", borderTop: `1px solid ${p.line}` }}>
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        <div className="ys-about-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24, marginTop: 16 }}>
          {items.map((it) =>
          <div key={it.n} style={{
            padding: 28,
            ...
            transition: "transform 200ms ease, box-shadow 200ms ease"
              ...
              <h3 style={{
              fontFamily: `'${displayFont}', serif`,
              fontSize: "clamp(22px, 2.4vw, 26px)", fontWeight: 400, letterSpacing: "-0.01em",
              margin: 0, lineHeight: 1.1, color: p.ink
            }}>{it.title}</h3>
              <p style={{
        ...
        <div className="ys-contact-grid" style={{ display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 64 }}>
          <div>
            ...
            <div style={{
              ...
              <div style={{
                fontFamily: `'${displayFont}', serif`,
                fontSize: "clamp(28px, 3vw, 36px)", lineHeight: 1.1, color: p.ink,
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
            ...
            <a
              ...
              style={{
                ...
                <div style={{ fontSize: 14, color: p.inkSoft, marginTop: 10 }}>
                  {c.detail}
                </div>
              </a>
            )}
...
function ContactForm({ p, displayFont }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (api && api.submitContact) {
      ...
      try {
        ...
        result = { success: res.ok && body.success, error: body.error, data: body };
      } catch (err) {
        result = { success: false, error: "Network error. Please try again or call us." };
      }
    }
    ...
    <section id="contact-form" style={{
      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.6, color: p.inkSoft, marginTop: 14 }}>
            Have a question? We'll respond within one business day.
          </p>
        </div>
        ...
        {status === "success" ? (
          <div style={{
            ...
            onMouseOut={(e) => e.currentTarget.style.transform = "translateY(0)"}>Send another</button>
          </div>
        ) : (
          <form onSubmit={handleSubmit} style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }} className="ys-form-grid">
              <label style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                ...
                <input type="text" required style={inputStyle} value={form.name} onChange={e => update("name", e.target.value)} placeholder="Maria Garcia" />
              </label>
              <label style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                <span style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: p.inkSoft, fontWeight: 600 }}>
                  Phone
              ...
              <label style={{ display: "flex", flexDirection: "column", gap: 5, gridColumn: "1 / -1" }}>
                ...
                <textarea required rows={4} style={{ ...inputStyle, resize: "vertical" }} value={form.message} onChange={e => update("message", e.target.value)} placeholder="How can we help you?" />
              </label>
            </div>
            ...
            onMouseOver={(e) => { if (status !== "sending") { e.currentTarget.style.background = p.primarySoft; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 6px 20px rgba(44, 62, 80, 0.25)"; } }}
            onMouseOut={(e) => { if (status !== "sending") { e.currentTarget.style.background = p.primary; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "none"; } }}>
            ...
            <p style={{ fontSize: 12, color: p.inkSoft, marginTop: 12, lineHeight: 1.5, textAlign: "center" }}>
              Or call us directly at <a href="tel:8322103968" style={{ color: p.primary, fontWeight: 600, textDecoration: "none" }}>(832) 210-3968</a>
            </p>
          </form>
        )}
      </div>
...
function PropertyInquiry({ open, onClose, p, displayFont, initialProperty }) {
  ...
  return (
    <div
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: p.accent, fontWeight: 600 }}>
              {status === "success" ? "Sent" : "Property inquiry"}
            </div>
            <div style={{
              fontFamily: `'${displayFont}', serif`,
              fontSize: 24, color: p.ink, marginTop: 4, fontWeight: 400
            }}>
              {status === "success" ? "Inquiry sent" : "Ask about a property"}
            </div>
          </div>
        ...
        {/* Body */}
        <div style={{ flex: 1, overflowY: "auto", padding: 24, background: p.paper }}>
          {status === "success" ? (
            <div style={{ textAlign: "center", padding: "16px 0 32px" }}>
              ...
              <h3 style={{
                fontFamily: `'${displayFont}', serif`,
                fontSize: 26, fontWeight: 400, margin: "0 0 12px", color: p.ink
              }}>We'll be in touch shortly.</h3>
              <p style={{ color: p.inkSoft, maxWidth: "40ch", margin: "0 auto", lineHeight: 1.55 }}>
                Your inquiry has been sent to our leasing team. We typically respond within one business day.
              </p>
              ...
              onMouseOver={(e) => e.currentTarget.style.transform = "translateY(-1px)"}
              onMouseOut={(e) => e.currentTarget.style.transform = "translateY(0)"}>Close</button>
            </div>
          ) : (
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <label style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                <span style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: p.inkSoft, fontWeight: 600 }}>Property *</span>
                <select
                  required
                  style={inputStyle}
                  value={property}
                ...
                >
                  ...
                  {PROPERTIES_LIST.map(o => <option key={o}>{o}</option>)}
                </select>
              </label>

              <label style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                <span style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: p.inkSoft, fontWeight: 600 }}>Your name *</span>
                <input type="text" required style={inputStyle} value={name} onChange={e => setName(e.target.value)} placeholder="Maria Garcia" />
              </label>

              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }} className="ys-book-row">
                <label style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                  <span style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: p.inkSoft, fontWeight: 600 }}>Phone</span>
                  <input type="tel" style={inputStyle} value={phone} onChange={e => setPhone(e.target.value)} placeholder="(832) 210-3968" />
                </label>
                <label style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                  <span style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: p.inkSoft, fontWeight: 600 }}>Email</span>
                  <input type="email" style={inputStyle} value={email} onChange={e => setEmail(e.target.value)} placeholder="you@email.com" />
                </label>
              </div>
              <div style={{ fontSize: 12, color: p.inkSoft, marginTop: -6 }}>Phone or email — at least one so we can reply.</div>

              <label style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                <span style={{ fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: p.inkSoft, fontWeight: 600 }}>Message *</span>
                <textarea required rows={3} style={{ ...inputStyle, resize: "vertical" }} value={message} onChange={e => setMessage(e.target.value)} placeholder="What would you like to know?" />
              </label>
              ...
              <button type="submit" disabled={!canSubmit || status === "sending"} style={{
                marginTop: 6,
                padding: "14px 24px",
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        <div className="ys-footer-grid" style={{
          ...
          <div>
            ...
            {[
              ...
              { name: "Royal Oaks", id: "royal-oaks" },
              { name: "White House", id: "white-house" }
            ].map((prop) => (
              <a key={prop.id} href={`#properties`} style={footerLink}
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            ...
            <a href="Yellowstone Management.html" style={{ color: "inherit", textDecoration: "none", transition: "color 200ms ease" }}
              onMouseOver={(e) => e.currentTarget.style.color = p.accent}
              onMouseOut={(e) => e.currentTarget.style.color = "inherit"}>EN</a>
            <span style={{ opacity: 0.3 }}>·</span>
            <a href="Yellowstone Management ES.html" style={{ color: "inherit", textDecoration: "none", transition: "color 200ms ease" }}
              onMouseOver={(e) => e.currentTarget.style.color = p.accent}
              onMouseOut={(e) => e.currentTarget.style.color = "inherit"}>ES</a>
          </div>
        </div>
      </div>
    </footer>
...
function App() {
  ...
  useEffect(() => {
    ...
    return () => { delete window.__openInquiry; };
  }, []);
  ...
  return (
    <div style={{ background: p.bg, color: p.ink, minHeight: "100vh" }}>
      ...
      <ContactForm p={p} displayFont={tweaks.displayFont} />
      <InstagramFeed p={p} displayFont={tweaks.displayFont} />
